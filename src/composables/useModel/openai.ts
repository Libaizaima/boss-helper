...
/**
 * 根据 chat completions URL 推导出 /models 端点，
 * 然后请求并返回模型 id 列表。
 */
...
const info: llmInfo<openaiLLMConf> = {
  ...
  url: {
    desc: '填写 Base URL（不含 /chat/completions），代码会自动拼接。常用地址: <br/> OpenAI: https://api.openai.com/v1 <br/> DeepSeek: https://api.deepseek.com/v1 <br/> Kimi: https://api.moonshot.cn/v1 <br/> 智谱: https://api.zhipuai.cn/v1 <br/> 百川: https://api.baichuan-ai.com/v1',
    type: 'input',
    config: {
